...
<div id="signup-signin-box" style="display:none;">
  ...
  <div id="sign-up-form">
    <div class="form-container">
      ...
      <p>To activate your Constant Contact forms, we will now create your account on MailMunch (<a onclick="showWhyAccount();" id="why-account-btn">Why?</a>).</p>

      <div id="why-account" class="alert alert-warning" style="display: none;">
        <h4>Why do I need a MailMunch account?</h4>

        <p>
          MailMunch is a not just a WordPress plugin but a standalone service. An account is required to identify your WordPress and serve your Constant Contact forms.
        </p>
      </div>
  ...
  <div id="sign-in-form" class="active">
    ...
    <p>Forgot your password? <a href="<?php echo CONSTANTCONTACT_MAILMUNCH_URL; ?>/users/password/new" target="_blank">Click here</a> to retrieve it.</p>
