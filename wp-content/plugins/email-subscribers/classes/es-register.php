		...
		<div>
			<form class="es_widget_form">
				<div class="subscribe-title">
					Want More For Your Glove?
				</div>
				<div class="subscribe-detail">
					Join our newsletter for tips, deals & more!
				</div>
				<div class="subscribe-div row">
					<div class="subScribe-text col-md-2">Subscribe</div>
					<div class="es_textbox col-md-9 col-xs-9">
					...
					<div class="es_button col-md-1 col-xs-3">
						<div class="es_textbox_button" name="es_txt_button" id="es_txt_button" onClick="return es_submit_page('<?php echo $url; ?>')">
						</div>
