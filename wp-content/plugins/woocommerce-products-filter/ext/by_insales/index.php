...
final class WOOF_EXT_BY_INSALES extends WOOF_EXT
{
    ...
    public function init()
    {
        ...
        self::$includes['js_init_functions'][$this->html_type] = 'woof_init_insales';
    }
...
WOOF_EXT::$includes['html_type_objects']['by_insales'] = new WOOF_EXT_BY_INSALES();
