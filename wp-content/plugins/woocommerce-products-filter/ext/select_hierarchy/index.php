    ...
    public function init()
    {
        ...
        $this->taxonomy_type_additional_options = array(
            'show_chain_always' => array(
                ...
                'tip' => __('Allows show disabled drop-downs with its custom name. Necessary changing custom taxonomy label to title like: Country+City+District', 'woocommerce-products-filter'),
                'type' => 'select',
                'options' => array(
