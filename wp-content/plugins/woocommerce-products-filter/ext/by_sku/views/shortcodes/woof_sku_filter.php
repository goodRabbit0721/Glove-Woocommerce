...
<div data-css-class="woof_sku_search_container" class="woof_sku_search_container woof_container">
    ...
    <div class="woof_container_inner">
        ...
        <table class="woof_sku_table">
            <tr>
                <td style="width: 100%;">
                    <input type="search" class="woof_show_sku_search <?php echo $unique_id ?>" id="<?php echo $unique_id ?>" data-uid="<?php echo $unique_id ?>" placeholder="<?php echo(isset($placeholder) ? $placeholder : $p) ?>" name="woof_sku" value="<?php echo $woof_sku ?>" />
                </td>
                <td>
