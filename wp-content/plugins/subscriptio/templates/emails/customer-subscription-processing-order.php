...
/**
 * Customer Subscription Processing Order email template
 */
...
<p><?php printf(__('Your subscription renewal order is now being processed. Your order details are shown below for your reference:', 'subscriptio'), get_option('blogname')); ?></p>
