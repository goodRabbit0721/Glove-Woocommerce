...
/**
 * Customer Subscription Expired email template
 */
...
<p><?php printf(__('Your subscription on %s has expired.', 'subscriptio'), get_option('blogname')); ?></p>

<p><?php _e('Details of the expired subscription are shown below for your reference:', 'subscriptio'); ?></p>
