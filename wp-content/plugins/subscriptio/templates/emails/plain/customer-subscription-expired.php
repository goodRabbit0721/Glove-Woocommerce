...
echo sprintf(__('Your subscription on %s has expired.', 'subscriptio'), get_option('blogname')) . "\n\n";

echo __('Details of the expired subscription are shown below for your reference:', 'subscriptio') . "\n\n";
