...
echo sprintf(__('Your subscription on %s has been resumed.', 'subscriptio'), get_option('blogname')) . "\n\n";

echo __('Details of the resumed subscription are shown below for your reference:', 'subscriptio') . "\n\n";
