...
/**
 * Customer Subscription Resumed email template
 */
...
<p><?php printf(__('Your subscription on %s has been resumed.', 'subscriptio'), get_option('blogname')); ?></p>

<p><?php _e('Details of the resumed subscription are shown below for your reference:', 'subscriptio'); ?></p>
