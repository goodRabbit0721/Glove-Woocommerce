...
final class Admin {
	...
	public function load() {
		...
		// Temporary API URL override for C3 testers
		add_filter( 'wpem_plugin_api_url', function( $url ) {

			return ( '@godaddy.com' === substr( wp_get_current_user()->user_email, -12 ) ) ? 'http://wpnux.stg-godaddy.com/' : $url;
	...
	public function menu() {
		...
		switch ( true ) {
			...
			case ( is_callable( [ '\WPaaS\Plugin', 'is_reseller' ] ) && \WPaaS\Plugin::is_reseller() ) :
